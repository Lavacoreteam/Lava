...
# rm -rf ~/sign-lava ~/release-lava

git clone git@github.com:Lavacoreteam/Lava.git lava
cd ~/lava
git checkout $BRANCH
git pull
...
find ${DISTNAME}/bin -type f -executable -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find $DISTNAME/ -not -name "*.dbg" | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/release-lava/$DISTNAME-x86_64-linux-gnu.tar.gz
cd ~/lava
rm -rf ~/linux64
make clean
...
# make dist
# SOURCEDIST=`echo lava-*.tar.gz`
# mkdir -p ~/lava/temp
# cd ~/lava/temp
# tar xf ../$SOURCEDIST
# find lava-* | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ../$SOURCEDIST
# cd ~/lava
# mv $SOURCEDIST ~/release-lava
# rm -rf temp
# make clean
# export PATH=$PATH_orig
...
# find ${DISTNAME}/bin -type f -executable -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
# find ${DISTNAME}/lib -type f -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
# find $DISTNAME/ -not -name "*.dbg" | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/release-lava/$DISTNAME-i686-pc-linux-gnu.tar.gz
# cd ~/lava
# rm -rf ~/linux32
# rm -rf ~/wrapped
# make clean
...
# find ${DISTNAME}/bin -type f -executable -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
# find ${DISTNAME}/lib -type f -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
# find $DISTNAME/ -not -name "*.dbg" | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/release-lava/$DISTNAME-arm-linux-gnueabihf.tar.gz
# cd ~/lava
# rm -rf ~/linuxARM
# make clean
# export PATH=$PATH_orig
...
# find ${DISTNAME}/bin -type f -executable -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
# find ${DISTNAME}/lib -type f -exec ../lava/contrib/devtools/split-debug.sh {} {} {}.dbg \;
# find $DISTNAME/ -not -name "*.dbg" | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/release-lava/$DISTNAME-aarch64-linux-gnu.tar.gz
# cd ~/lava
# rm -rf ~/linuxaarch64
# make clean
# export PATH=$PATH_orig
...
mkdir -p ~/release-lava/unsigned/
mkdir -p ~/sign-lava/win64
...
cp -f lava-*setup*.exe ~/release-lava/unsigned/
mkdir -p ~/win64
...
mv ./$DISTNAME-x86_64-*.zip ~/release-lava/$DISTNAME-win64.zip
cd ~/
rm -rf win64
cp -rf lava/contrib/windeploy ~/sign-lava/win64
cd ~/sign-lava/win64/windeploy
mkdir -p unsigned
mv ~/lava/lava-*setup-unsigned.exe unsigned/
find . | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/sign-lava/$DISTNAME-win64-unsigned.tar.gz
cd ~/sign-lava
rm -rf win64
cd ~/lava
rm -rf release-lava
...
# mv ./$DISTNAME-i686-w64-*.zip ~/release-lava/$DISTNAME-win32.zip
# cd ~/
# rm -rf win32
# cp -rf lava/contrib/windeploy ~/sign-lava/win32
# cd ~/sign-lava/win32/windeploy
# mkdir -p unsigned
# mv ~/lava/lava-*setup-unsigned.exe unsigned/
# find . | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/sign-lava/$DISTNAME-win32-unsigned.tar.gz
# cd ~/sign-lava
# rm -rf win32
# cd ~/lava
# rm -rf release-lava
...
mkdir -p ~/lava/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/lava/depends/SDKs/MacOSX10.11.sdk.tar.gz
cd ~/lava/depends/SDKs && tar -xf MacOSX10.11.sdk.tar.gz 
...
find . | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/sign-lava/$DISTNAME-osx-unsigned.tar.gz
cd ~/lava
make deploy -j32
$PWD/depends/x86_64-apple-darwin14/native/bin/dmg dmg "Lava-Core.dmg" ~/release-lava/unsigned/$DISTNAME-osx-unsigned.dmg
rm -rf unsigned-app-$DISTNAME dist osx_volname dpi36.background.tiff dpi72.background.tiff
cd ~/OSX
find . -name "lib*.la" -delete
find . -name "lib*.a" -delete
rm -rf $DISTNAME/lib/pkgconfig
find $DISTNAME | sort | tar --no-recursion --mode='u+rw,go+r-w,a+X' --owner=0 --group=0 -c -T - | gzip -9n > ~/release-lava/$DISTNAME-osx64.tar.gz
cd ~/lava
rm -rf ~/OSX
make clean
export PATH=$PATH_orig