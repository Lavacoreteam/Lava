...
UniValue elysium_sendrawtx(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            ...
            "5. referenceamount      (string, optional) a lava amount that is sent to the receiver (minimal by default)\n"
            "\nResult:\n"
...
UniValue elysium_send(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 4 || params.size() > 6)
        throw runtime_error(
            ...
            "6. referenceamount      (string, optional) a lava amount that is sent to the receiver (minimal by default)\n"
...
UniValue elysium_senddexsell(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 7)
        throw runtime_error(
            ...
            "4. amountdesired        (string, required) the amount of lavas desired\n"
...
UniValue elysium_sendissuancecrowdsale(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 14)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("elysium_sendissuancecrowdsale", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\" 2 1 0 \"Companies\" \"Lava Mining\" \"Quantum Miner\" \"\" \"\" 2 \"100\" 1483228800 30 2")
            + HelpExampleRpc("elysium_sendissuancecrowdsale", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\", 2, 1, 0, \"Companies\", \"Lava Mining\", \"Quantum Miner\", \"\", \"\", 2, \"100\", 1483228800, 30, 2")
        );
...
UniValue elysium_sendissuancefixed(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 10 || params.size() > 11)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("elysium_sendissuancefixed", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\" 2 1 0 \"Companies\" \"Lava Mining\" \"Quantum Miner\" \"\" \"\" \"1000000\"")
            + HelpExampleRpc("elysium_sendissuancefixed", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\", 2, 1, 0, \"Companies\", \"Lava Mining\", \"Quantum Miner\", \"\", \"\", \"1000000\"")
        );
...
UniValue elysium_sendissuancemanaged(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 9 || params.size() > 10)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("elysium_sendissuancemanaged", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\" 2 1 0 \"Companies\" \"Lava Mining\" \"Quantum Miner\" \"\" \"\"")
            + HelpExampleRpc("elysium_sendissuancemanaged", "\"aGoK6MF87K2SgT7cnJFhSWt7u2cAS5m18p\", 2, 1, 0, \"Companies\", \"Lava Mining\", \"Quantum Miner\", \"\", \"\"")
        );
...
UniValue elysium_sendspend(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 4) {
        throw std::runtime_error(
            ...
            "4. referenceamount              (string, optional) a lava amount that is sent to the receiver (minimal by default)\n"
            "\nResult:\n"
            "\"hash\"                          (string) the hex-encoded transaction hash\n"
            "\nExamples:\n"
