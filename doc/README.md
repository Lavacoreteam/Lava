...
Drag Lava-Core to your applications folder, and then run Lava-Core.
...
Development
---------------------
The Lava repo's [root README](/README.md) contains relevant information on the development process and automated testing.
