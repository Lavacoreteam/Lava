...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/Lavacoreteam/Lava/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Lava Core for Linux, Windows, and OS X:
    ...
    mv build/out/lava-*.zip build/out/bitcoin-*.exe ../

    ./bin/gbuild --memory 3000 --commit lava=v${VERSION} ../lava/contrib/gitian-descriptors/gitian-osx.yml
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the znode.io server
  into `/var/www/bin/lava-core-${VERSION}`
...
- Announce the release:
  ...
  - Lava Core announcements list https://bitcoincore.org/en/list/announcements/join/
